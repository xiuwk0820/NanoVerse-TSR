...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    _datasets_root = Path(__file__).resolve().parent.parent / "data" / "datasets"
    datasets_path               = str(_datasets_root)
    datasets_train_json_path    = str(_datasets_root / "CLIP_new_train_data.json")
    datasets_val_json_path      = str(_datasets_root / "CLIP_new_test_data.json")
